...
class HomeScreen extends StatefulWidget {
  const HomeScreen({super.key, required this.currentUser, required this.role});
...
class _HomeScreenState extends State<HomeScreen> {
      ...
      return SingleChildScrollView(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(child: _mainContent(canCreateEvent: canCreateEvent, canCreateJobOffer: canCreateJobOffer)),
            const SizedBox(width: 16),
            SizedBox(width: 300, child: _rightSidebar(canCreateJobOffer: canCreateJobOffer)),
          ],
        ),
      );
    }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _mainContent(canCreateEvent: canCreateEvent, canCreateJobOffer: canCreateJobOffer),
          const SizedBox(height: 12),
            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  gradient: LinearGradient(colors: [KairosPalette.primary, KairosPalette.accent]),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(widget.currentUser.name, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                    Text(widget.currentUser.title, style: const TextStyle(color: KairosPalette.secondary)),
                    const SizedBox(height: 14),
                    _statRow('Conexiones', widget.currentUser.connections.toString()),
                    _statRow('Vistas', '89'),
                  ],
                ),
              ),
            ...
            children: [
              const Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('En demanda', style: TextStyle(fontWeight: FontWeight.w800)),
                ],
              ),
              ...
              Wrap(
                ...
                children: trendingSkills
                    .map((skill) => Chip(
                          label: Text(skill, style: const TextStyle(fontWeight: FontWeight.w700)),
  ...
  Widget _mainContent({required bool canCreateEvent, required bool canCreateJobOffer}) {
    return Column(
      children: [
        KCard(
          child: Column(
            children: [
              Row(
                children: [
                  CircleAvatar(radius: 22, backgroundImage: NetworkImage(widget.currentUser.avatarUrl)),
        ...
        KCard(
          child: Column(
            ...
            children: [
              const Row(
                children: [
                  Icon(Icons.tips_and_updates_rounded, color: KairosPalette.primary),
                  SizedBox(width: 8),
                  Text('Consejos del dia', style: TextStyle(fontWeight: FontWeight.w800)),
                ],
              ),
              const SizedBox(height: 10),
            ...
            children: [
              const Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('Oficios destacados', style: TextStyle(fontWeight: FontWeight.w800)),
                ],
              ),
              const SizedBox(height: 10),
              ...highlightedTrades.asMap().entries.map(
                    (entry) => ListTile(
                      ...
                      trailing: Text(
                        ...
                        style: const TextStyle(color: KairosPalette.primary, fontWeight: FontWeight.w800),
                      ),
                    ),
                  ),
            ],
        ...
        if (canCreateJobOffer) ...[
          ...
          KCard(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Publica una oferta', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text(value, style: const TextStyle(fontWeight: FontWeight.w800, color: KairosPalette.primary)),
        ],
      ),
    );
  }
