...
class _PostCardState extends State<PostCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return KCard(
      borderColor: post.isEvent ? KairosPalette.primary.withValues(alpha: 0.4) : KairosPalette.border,
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                CircleAvatar(radius: 22, backgroundImage: NetworkImage(post.author.avatarUrl)),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(post.author.name, style: const TextStyle(fontWeight: FontWeight.w800)),
                      Text(
                        post.author.title,
                      ...
                      Text(
                        post.timestamp,
                        style: const TextStyle(color: KairosPalette.secondary, fontSize: 11),
                      ),
                    ],
                  ),
                ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Text('$_likes Me gusta', style: const TextStyle(fontWeight: FontWeight.w700)),
                const Spacer(),
